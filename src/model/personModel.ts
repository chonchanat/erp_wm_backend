    ...
    try {
        ...
        let result = await pool.request()
            ...
            .query(`
                ...
                EXEC DevelopERP_ForTesting..sp_filterPerson @customer_id = NULL, @fleet_id = NULL, @vehicle_id = NULL, @firstIndex = @firstIndex, @lastIndex = @lastIndex
                EXEC DevelopERP_ForTesting..sp_formatPersonTable @personTable = @personTable, @fullname = @fullname, @firstIndex = @firstIndex
