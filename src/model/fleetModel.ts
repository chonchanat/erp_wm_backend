    ...
    try {
        ...
        let result = await pool.request()
            ...
            .query(`
                ...
                EXEC DevelopERP_ForTesting..sp_filterFleet @customer_id = NULL
    ...
    try {
        ...
        let result = await pool.request()
            ...
            .query(`
                ...
                EXEC DevelopERP_ForTesting..sp_filterPerson @customer_id = NULL, @fleet_id = @fleet_id, @vehicle_id = NULL, @firstIndex = 0, @lastIndex = 0
